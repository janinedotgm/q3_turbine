...
use crate::state::{StakeAccount, StakeConfig, UserAccount};
 ...
 impl<'info> Unstake<'info> {
    ...
    pub fn revoke_delegation(&mut self) -> Result<()> {
    ...
    pub fn thaw_account(&mut self) -> Result<()> {
        ...
        let time_elapsed = ((current_time - self.stake_account.last_updated) / seconds_per_day) as u32;
        
        // require!(time_elapsed > self.config.freeze_period, StakeError::TimeElapsed);
